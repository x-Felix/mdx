...
<footer class="foot mdui-text-center<?php if (mdx_get_option("mdx_styles_footer") === "2") { ?> mdx-footer-clean<?php } else if (mdx_get_option("mdx_styles_footer") === "3") { ?> mdx-footer-morden<?php } ?>">
    <?php if (mdx_get_option("mdx_styles_footer") === "1") {
        ...
        } else if ($mdx_footer_say == '--HitokotoAPIActivated--') { ?><br>&nbsp;
        ...
        } else if ($mdx_footer_say == '--HitokotoPoemAPIActivated--') { ?><br>&nbsp;
        ...
        } else if (substr($mdx_footer_say, 0, 21) === '--CustomAPIActivated(') { ?><br>&nbsp;
    ...
    <?php } else if (mdx_get_option("mdx_styles_footer") === "3") { ?>
        <div class="mdx-clean-footer">
            ...
            <span class="mdx-footer-content"><?php if (!empty(mdx_get_option('mdx_footer'))) {
                    echo htmlspecialchars_decode(mdx_get_option('mdx_footer'));
                }
...
if (is_home()) {
    ...
    $mdx_js_name = 'ac';
} elseif (is_single() || $pageType == 'page-postlike.php') {
    $mdx_js_name = 'post';
} elseif (is_page() || $pageType != 'page-postlike.php') {
    $mdx_js_name = 'page';
} elseif (is_page() && $pageType == 'page-postlike.php') {
    $mdx_js_name = 'post';
} else {
